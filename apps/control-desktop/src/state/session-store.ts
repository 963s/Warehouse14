/**
 * Zustand store — current operator session (governance desktop).
 *
 ...
 * to `'authenticated'`. (Mirrors apps/tauri-pos/src/state/session-store.ts.)
 */
 ...
 * PIN pad (which implies "your session ended — log in again"). Instead the gate
