/**
 * LocalLock — the local device quick-unlock gate (Track A2). Sits over an
 * already-authenticated Google session. If a code is set, it asks for it; if
 * none is set, it offers to create one (skippable). The real login is always
 * Google — this is only the fast, per-device re-entry layer.
 */
