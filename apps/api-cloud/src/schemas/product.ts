...
export const CreateProductBody = Type.Object({
  ...
  karatCode: Type.Optional(Type.String({ maxLength: 16, description: 'Reference to karat_grades.code (e.g. "K585").' })),
...
export const UpdateProductBody = Type.Object({
  ...
  yearMintedFrom: Type.Optional(Type.Union([Type.Integer({ minimum: -3000, maximum: 9999 }), Type.Null()])),
  yearMintedTo: Type.Optional(Type.Union([Type.Integer({ minimum: -3000, maximum: 9999 }), Type.Null()])),
