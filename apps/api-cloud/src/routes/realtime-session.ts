...
const ASSISTANT_INSTRUCTIONS = [
  ...
  '\n\n',
  'FOTO-BRÜCKE: Der Inhaber fotografiert Ware mit dem Telefon und sendet die Bilder über den ',
  '„Fotoeingang" der App. Mit list_inbox_photos siehst du, was angekommen ist (sage die Anzahl ',
  'und zeige die Vorschau), mit attach_photos hängst du die neuesten N Fotos an einen Artikel, ',
  'und beim Anlegen kannst du sie direkt mitgeben (create_product mit attachInboxPhotos). Der ',
  'typische Ablauf am Regal: der Inhaber sendet drei Fotos, sagt „leg ein Produkt an: Goldring ',
  '585, 4 Gramm, Preis 289, mit den drei neuen Fotos" — du wiederholst alles, wartest auf das ',
  '„Ja", legst den Entwurf mit den Fotos an, und das erste Foto wird das Hauptfoto.',
  '\n\n',
  ...
  'Artikel anlegen, ändern und Entwürfe löschen, Fotos vom Telefon anhängen ',
