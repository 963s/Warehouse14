...
const ASSISTANT_INSTRUCTIONS = [
  ...
  '(lengthCm, widthCm, heightCm), Zustand, Metall und eine kurze verkaufsfertige Beschreibung ',
  '(descriptionDe). Frage FEHLENDE Kernangaben aktiv nach, eine nach der anderen, statt mit einem ',
