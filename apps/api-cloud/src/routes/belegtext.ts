...
import { type SQL, and, desc, eq, sql as drizzleSql } from 'drizzle-orm';
...
const belegtextRoutes: FastifyPluginAsync = async (app) => {
  ...
  // ────────────────────────────────────────────────────────────────────
  app.get<{ Querystring: TListBelegtextQuery }>('/api/belegtext-templates', {
    schema: {
      tags: ['belegtext'],
  ...
  // ────────────────────────────────────────────────────────────────────
  app.get<{ Querystring: TCurrentBelegtextQuery }>('/api/belegtext-templates/current', {
    schema: {
      tags: ['belegtext'],
  ...
  // ────────────────────────────────────────────────────────────────────
  app.get<{ Querystring: TResolveBelegtextQuery }>('/api/belegtext-templates/resolve', {
    schema: {
      tags: ['belegtext'],
  ...
  // ────────────────────────────────────────────────────────────────────
  app.post<{ Body: TPublishBelegtextBody }>('/api/belegtext-templates', {
    schema: {
      tags: ['belegtext'],
