...
export const Cart: Story = {
  render: () => (
    <ul style={{ listStyle: 'none', padding: 0, lineHeight: 1.9 }}>
      <li><RomanIndex value={1} /> &nbsp; 1oz Krugerrand</li>
      <li><RomanIndex value={2} /> &nbsp; Silberbarren 500g</li>
      <li><RomanIndex value={3} /> &nbsp; Antike Taschenuhr</li>
      <li><RomanIndex value={4} /> &nbsp; Briefmarken-Konvolut</li>
    </ul>
  ),
};
